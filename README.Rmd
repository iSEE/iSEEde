...
The goal of `iSEEde` is to provide panels that facilitate the interactive visualisation of differential expression results in `r BiocStyle::Biocpkg("iSEE")` applications.
